<template>
    <div class="container-fluid mt-5">
        <!-- Barre de recherche -->
        <div style="margin-block-start: 250px;" class="text-center mb-4">
            ...
            <div style="margin-inline-start: 180px;" class="col-md-9 col-12 offset-md-3">
                ...
                <section v-if="filteredAlbums.length">
                    <div class="row">
                            ...
                            <div class="card shadow-sm">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <!-- Bouton Play Music -->
                                        <button @click="playMusic(album.track_url)"
                        ...
                        <div class="col-md-4 mb-4" style="background-color: transparent; margin-left: -320px; margin-top: -365px;">
                            <div class="card shadow-sm">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <audio style="margin-left: -10px; width: 250px; margin-top: 10px;" :src="demoTrackUrl" controls v-if="demoTrackUrl" ref="audioPlayer">
                                        Votre navigateur ne supporte pas l'élément audio.
                                    </audio>
                                </div>
                            </div>
